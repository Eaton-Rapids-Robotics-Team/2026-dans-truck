...
public final class Configs {
    public static final class SwerveModule {
        ...
        static final double drivingFactor = ModuleConstants.kWheelDiameterMeters * Math.PI / ModuleConstants.kDrivingMotorReduction; // TODO: Document why this is the case
        static final double nominalVoltage = 12.0; // TODO: This is correct right?
        static final double drivingVelocityFeedForward = nominalVoltage / ModuleConstants.kDriveWheelFreeSpeedRps; // TODO: Why is this the case?
        ...
        static {
                ...
                drivingConfig.closedLoop
                        ...
                        .pid(ModuleConstants.kDrivingP, ModuleConstants.kDrivingI, ModuleConstants.kDrivingD) // TODO Tune these values
                        .outputRange(-1, 1)
                ...
                turningConfig.absoluteEncoder
                        ...
                        .apply(AbsoluteEncoderConfig.Presets.REV_ThroughBoreEncoderV2); // TODO: Check if this is correct encoder
                turningConfig.closedLoop
                        .feedbackSensor(FeedbackSensor.kAbsoluteEncoder)
                        .pid(ModuleConstants.kTurningP, ModuleConstants.kTurningI, ModuleConstants.kTurningD) // TODO Tune these values
                        .outputRange(-1, 1)
    ...
    public static final class Shooter {
        ...
        static {
                ...
                leftShooterConfig
                        .follow(ShooterConstants.kRightShooterCanId, true);
    ...
    public static final class Feed {
        ...
        static {
                fingerLeftConfig
                        .follow(FeedConstants.kSorterRightCANId, true);
                fingerRightConfig
                        .idleMode(IdleMode.kCoast)
