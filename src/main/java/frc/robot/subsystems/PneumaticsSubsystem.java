...
public class PneumaticsSubsystem extends SubsystemBase{
    ...
    private final DoubleSolenoid m_climbSolenoid = new DoubleSolenoid(2, PneumaticsModuleType.REVPH, 7, 5);
    private final DoubleSolenoid m_intakSolenoid = new DoubleSolenoid(2, PneumaticsModuleType.REVPH, 9, 8);
