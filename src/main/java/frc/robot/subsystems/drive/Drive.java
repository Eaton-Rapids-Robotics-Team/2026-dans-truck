...
public class Drive extends SubsystemBase {
  public static Field2d yourfield = new Field2d();
  ...
  public void periodic() {
    ...
    yourfield.setRobotPose(this.getPose());
    SmartDashboard.putData("feild", yourfield);
    // Update gyro alert
  ...
  public void updateOdometry() {
    ...
    if (useMegaTag2 == false) {
      ...
      // if(Math.abs(gyroIO.) > 720) // if our angular velocity is greater than 720 degrees per
